...
- **K1 — module nets:** each repo's own suite at its own gates (the BASE rows above; this spec's three-tier methodology §2 is the per-repo shape). ALL GREEN at the R27 pins — OT's milestone register grew to **72 entries** (M44-M58 + the M49T/H/R/G + M51R/M55R/M57R/M58R real-mouse families + the M49C coverage gate), the engine net 440→458→**748**, nle-ui 648→674→**690**, the app roof 117→174→**252 (8 suites)**.
