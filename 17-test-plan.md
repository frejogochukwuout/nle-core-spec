...
**BASE (accepted, pinned 2026-09-07):** the three-tier methodology + matrix + template (§2-§11); the facet matrix §13A; the roof-suite law §17A — all EXECUTING (the fleet's suites are the proof: engine 356/356, OT 459/459 + 130 real-mouse, WDC 740/740, nle-ui 640, app 83/83, mini 353, variants 1334; all CI-green).
