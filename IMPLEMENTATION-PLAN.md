...
**S-engine (nle-engine):** the live queue (the projector parity corpus, the color instruments — spec 01/03/04/08 §0s; N2b LANDED @ `37cdd28`, consumed not queued) + K2's engine-side pairs → r2/r3/r6 consumption points as they land.
