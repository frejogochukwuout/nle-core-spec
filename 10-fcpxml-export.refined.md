...
**Seed spec:** `10-fcpxml-export.md`
**Refined spec:** `10-fcpxml-export.refined.md` (this file)
...
**Seed assumption (referenced from SCOUT-09 §11 Correction #3 in `09-project-model.refined.md` lines 1872-1880):**
