...
- (b) `maintainPitch` — **LANDED** (BASE above; scene-to-segments.ts:596/:623) — **RESOLVED end-to-end (R9-b, R27)**: `el.preservePitch` is ElementJSON law (absent≡true; nle-ui `6754979`); the app threads it (engineService.ts:510-513, sceneBridge.ts:262/:447); the engine's `retime.maintainPitch` (scene-to-segments :596/:623) is the runtime projection.
