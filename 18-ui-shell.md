...
- The mini DESIGN + law register (§16, `ui-mock/shell-mini` @ 357 tests — 333 at the R22 retirement, +10 review-loop nets, +12 R23 seal + fix-round nets, +2 R24 audio-clip-box nets; OT-SEAMS seam map; annotakit live review surface).
...
3. **Testing (§12 / spec 17 Tier 3)**: the mini carries 357 vitest tests
