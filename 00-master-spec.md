...
3. **Two algorithm homes:** opencut-timeline owns placement/zero-anchor/ripple-diff/split-snap-once/group-move + interaction controllers (specs 05 §14.4-14.6, 06 §5.1-5.4/5.9-5.10); nle-engine owns roll/slip/slide/rateStretch/retime/insert-edit-3-point/sync-lock (specs 06 §5.5-5.8/§5.11-5.14, §6). *(R9: clause superseded by Decision 12.3 — one algorithm home; the engine's families port-scheduled into OT.)*
