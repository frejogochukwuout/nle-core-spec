...
def _mini_scraped():
    ...
    return (passed == 357 and total == 357 and files == 8), f"scraped {passed}/{total} tests / {files} files (declared 357/8 — the R23 seal 355 + the R24-mini audio-clip-box nets)"
...
check("LAW-NET-INVENTORY arithmetic parses + sums (129 units / 357 / authored=357−33)", _inventory_math, "census math")
...
check("mini count current (357) + variants 1521+ live", lambda: (
    "357" in specs[18] and "1521" in s00, "mocks"))
        ...
        with open(f, encoding="utf-8") as fh:
            for line in fh:
                ...
                if s.startswith("it(") or s.startswith("it ("):
                    blocks += 1
    ok = ("1521+" in reg and "357" in reg and len(files) == 64 and blocks == 1733)
