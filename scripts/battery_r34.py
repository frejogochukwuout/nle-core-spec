#!/usr/bin/env python3
"""battery_r34.py — the Round-33 battery (the battery_r32 successor: THE INTAKE FOLD ROUND).
...
check("LIVE: the OT repo HEAD is ccff397 (docs-only over the 8f96ab2 carrier wave: CR-1/2/3/4/5/8/9 LANDED — the M59/59A/59B/59C/59D families + the M64 /view fps param + the SURFACE_OWNED_KEYS export rider; 714/714 @ 83 entries; the code pin 8f96ab2", lambda: (
    _git("opencut-timeline", "rev-parse", "--short", "HEAD") == "ccff397", _git("opencut-timeline", "rev-parse", "--short", "HEAD") or "HEAD unreadable"))
