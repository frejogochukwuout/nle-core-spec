...
def _e2_consistency():
    ...
    ow_ok = (re.search(r"performOverwriteEdit`? :6039", mat) and "E2 FIXED" in mat and "E3" in mat)
    ...
    ref_ok = ":5662" in specs[6] and ":6039" in specs[6]
...
check("B-6: the E1/E2/E3 cells agree across the matrix + GAP rows + §5.9B/OW-2 + §10.4 (FIXED/FIXED/open, :5662/:6039 — the R33 re-anchor to the PUBLIC methods; the impl cite _performOverwriteEditImpl :6055-6363 is 06:1577's own)", _e2_consistency, "E2 consistency")
...
check("LIVE: the nle-ui repo HEAD is 1e0c30b (743/743 — the R32 landings: the C0 MiniShell composition 701→737 with 78 stories + the ConfirmProvider/MiniShell exports; the D52 twin 737→743 — the optional TimelineRouter.isInteractionActive + the 9 doc-mutating row guards + the 6-pin family)", lambda: (
