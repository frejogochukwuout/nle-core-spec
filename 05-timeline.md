...
- Op-family variants slip/slide/roll/rateStretch + wave-2 retime/freezeFrame/rangeRemoval (**r1**; tests carried from nle-engine timeline.ts — acceptance: carried engine tests green).
