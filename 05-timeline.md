...
- Zoom-ladder config / ripple-toggle semantics exposure — the OT-side view-config surface (**the D25 bridge**, was the C1 OT-side halves; S-ot worklist item 3; acceptance: OT exposes the config + the C1 law-subset rows hold-on-OT).
