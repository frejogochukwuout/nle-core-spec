...
- The mini's editing keys — `ui-mock/shell-mini` (357 tests) + the law register `ui-mock/shell-mini/docs/OT-SEAMS.md`.
...
**ACCEPTANCE & TEST PLAN:** §9 (Test Verification) + Appendix A (the flat registry for enumeration) are this spec's battery; BASE acceptance = the cited suites at the cited pins (app 83; mini 357) — the regression role. GAP acceptance is per-row above; facet rows in spec 17 §13A.
