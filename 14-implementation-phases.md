...
| `ui-mock/shell-mini` + `shell-variants` | design references + law registers + live review surfaces; the mini carries the law net (**353 tests — the R22 drag-law retirement held (the verbatim R18k law) + the R22-R23 review/seal nets; 8 files**) and 60 static `mini-*` testids + 14 templated families (the census: LAW-NET-INVENTORY §2.2) | (same repo) | — | 353 + 1334 tests |
