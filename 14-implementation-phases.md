...
| `ui-mock/shell-mini` + `shell-variants` | design references + law registers + live review surfaces; the mini carries the law net (**357 tests — the R22 drag-law retirement held (the verbatim R18k law) + the R22-R24 review/seal nets; 8 files**) and 60 static `mini-*` testids + 15 templated families (the census: LAW-NET-INVENTORY §2.2) | (same repo) | — | 357 + 1334 tests |
